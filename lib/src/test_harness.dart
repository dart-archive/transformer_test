...
library transformer_test.src.test_harness;
...
class TestHelper implements PackageProvider {
  ...
  void run([Iterable<String> updatedPaths, Iterable<String> removedPaths]) {
    if (updatedPaths == null) updatedPaths = files.keys;
    barback.updateSources(updatedPaths.map(idFromString));
    if (removedPaths != null) {
      barback.removeSources(removedPaths.map(idFromString));
    }
  }
